...
class GPCMLinearKernel : public GPCMKernel
{
protected:
    // Variance.
    MatrixXd var;
    ...
    // Variance prior.
    GPCMPrior *varprior;
    // Temporary storage for computing gradient.
    MatrixXd kmat;
public:
    // Construct the kernel.
    GPCMLinearKernel(GPCMParams &params, GPCMOptimization *optimization, int dims);
