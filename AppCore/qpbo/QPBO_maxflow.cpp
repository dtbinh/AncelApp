...
*/
	...
	inline void QPBO::set_active(Node *i)
{
	if (!i->next)
	{
...
*/
	...
	inline QPBO::Node* QPBO::next_active()
{
	Node *i;
...
/***********************************************************************/
	...
	inline void QPBO::set_orphan_front(Node *i)
{
	nodeptr *np;
	...
	inline void QPBO::set_orphan_rear(Node *i)
{
	nodeptr *np;
	i -> parent = QPBO_MAXFLOW_ORPHAN;
	np = nodeptr_block -> New();
...
/***********************************************************************/
	...
	inline void QPBO::add_to_changed_list(Node *i)
{
	...
	void QPBO::maxflow_init()
{
	...
	void QPBO::maxflow_reuse_trees_init()
{
	Node* i;
	Node* j;
	...
	void QPBO::augment(Arc *middle_arc)
{
	Node *i;
	Arc *a;
	REAL bottleneck;
...
/***********************************************************************/
	...
	void QPBO::process_source_orphan(Node *i)
{
	Node *j;
	...
	void QPBO::process_sink_orphan(Node *i)
{
	Node *j;
	Arc *a0, *a0_min = NULL, *a;
	int d, d_min = INFINITE_D;
...
/***********************************************************************/
	...
	void QPBO::maxflow(bool reuse_trees, bool _keep_changed_list)
{
...
/***********************************************************************/
	...
	void QPBO::test_consistency(Node* current_node)
{
	Node *i;
	Arc *a;
	int r;
