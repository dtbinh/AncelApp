...
#include <inverse_chain.h> // The basic data structure

// Utility functions for extracting data
#include <inverse_compute_jacobian.h>
#include <inverse_set_joint_parameters.h>
#include <inverse_get_joint_parameters.h>
#include <inverse_compute_joint_limits_projection.h>
#include <inverse_compute_weighted_difference.h>

// Numerical methods
#include <math/optimization/optimization_projected_bfgs.h>
#include <math/optimization/optimization_projected_steepest_descent.h>

#include <math/big/big_prod_trans.h> // Needed for prod_trans

#include <utility/utility_timer.h>
...
namespace OpenTissue
{
  namespace kinematics
  {
    namespace inverse
    {
      ...
      /**
      * A Non-linear Inverse Kinematics Problem Solver.X
      *
