...
#include <math/math_value_traits.h>
#include <math/math_is_number.h>

#include <math/big/big_types.h>
#include <math/optimization/optimization_constants.h>
#include <math/optimization/optimization_stagnation.h>
#include <math/optimization/optimization_relative_convergence.h>
...
namespace OpenTissue
{
  namespace math
  {
    namespace optimization
    {
      ...
      *
      * This is the Armijo test used in an un-projected line-search. If a projected
      * line-search is done then we can think of x as a function of tau so we write
      *
      *    x(tau) = x + dx*tau
      *
      ...
      * @param P                     The projection operator, computes x = P(x).
